...
settoggle(!togle)
  ...
  return (
   ...
   <nav className={ `d-flex  flex-lg-row flex-column justify-content-lg-center justify-content-around  nav ${togle ? 'nav2' : ''}` }>
   <i class="fa-solid fa-xmark d-lg-none" onClick={()=>togglenav()}></i>
     <div className='position-relative px-4 innernav1 '><NavLink to="/" className="text-decoration-none navLink"> HOME <i class="fa-solid fa-chevron-down "></i> </NavLink>
         <div className='innernav2 bg-white  d-flex flex-column px-4 gap-2 py-2'>
     ...
     <div className='position-relative px-4 innernav1  '><NavLink to="/accomedation" className="text-decoration-none navLink">ACCOMMODATION<i class="fa-solid fa-chevron-down"></i> </NavLink>
     ...
     <div className='position-relative px-4 innernav1 '><NavLink to="/destinations" className="text-decoration-none navLink">DESTINATION<i class="fa-solid fa-chevron-down"></i> </NavLink>
         <div className='innernav2 bg-white text-dark d-flex flex-column px-4 gap-2 py-2'>
     ...
     <div className='position-relative px-4 innernav1 '><NavLink className="text-decoration-none navLink">SHOP<i class="fa-solid fa-chevron-down"></i> </NavLink>
         <div className='innernav2 bg-white text-dark d-flex flex-column px-4 gap-2 py-2'>
     ...
     <div className='position-relative px-4 innernav1 '><NavLink to="/blog" className="text-decoration-none navLink">NEWS<i class="fa-solid fa-chevron-down"></i> </NavLink>
         <div className='innernav2 bg-white text-dark d-flex flex-column px-4 gap-2 py-2'>
